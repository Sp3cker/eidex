...
const findNodeById = (node: FamilyTreeNode, targetId: number): FamilyTreeNode | null => {
...
const getAllDescendants = (node: FamilyTreeNode): Array<{node: FamilyTreeNode, depth: number}> => {
