...
const Dexnav = memo(function Dexnav() {
  ...
  return (
    <animated.nav
      style={springs}
      className="map-place-info-textbox-gradient fixed bottom-7 left-10 right-10 h-2/5 overflow-scroll rounded-sm py-2 pl-3 shadow-lg"
    >
      <div className="flex justify-between text-white">
        <h1 className="cool-font font-bold text-neutral-700 pb-2">
